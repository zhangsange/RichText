...
public class GifActivity extends AppCompatActivity {
    ...
    private static final String GIF_TEST = "<h3>Gif Test</h3><img src=\"http://ww4.sinaimg.cn/large/5cfc088ejw1f3jcujb6d6g20ap08mb2c.gif\"/>" +
            ...
            "<h3>Test3</h3><img src=\"https://p3.pstatp.com/large/pgc-image/f3849dc1f4dd45d8bdf39ca54237f39e\"/>"
            ;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RichText.from(GIF_TEST).autoFix(false).showBorder(true).autoPlay(true)
                .imageClick(new OnImageClickListener() {
                    @Override
                    public void imageClicked(List<String> imageUrls, int position, Attributes attributes, RichText richText) {
                        System.out.println(richText.imageHolderMap);
                    }
                }).into(textView);
    }
